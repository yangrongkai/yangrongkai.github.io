...
> <span class="fg"> **注**：当医生申请完订单后，系统会自动发送消息给“高姐”。</span>

**2. 医生检测记录跟踪**
<div class="album">
   <figure>
      <img src="{{ "/media/img/20170328/my_nav.png" | absolute_url }}" />
      <figcaption>医生检测订单管理</figcaption>
   </figure>
   <figure>
...
**3. crm检测订单干预**
<div class="tip fr">crm只能对 “<b>自营</b>” 的供应商进行干预操作。(干预：不通过登录供应商端进行订单操作）</div>
...
<div class="album">
   <figure>
      ...
      <figcaption>crm供应商管理</figcaption>
   <jfigure>
   <figure>
